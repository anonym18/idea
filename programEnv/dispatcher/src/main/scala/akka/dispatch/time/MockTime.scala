...
object MockTime {
  ...
  def scheduleOnce(initialDelay: FiniteDuration, receiver: ActorRef, msg: Any)(implicit executor: ExecutionContext): Cancellable =
    time.scheduler.scheduleOnce(initialDelay, receiver, msg)
...
//TODO Read the configuration "debugging-dispatcher.useVirtualTimer" and throw exception of timer is used when the option is set to false
